...
)  # (exome_slicer/config/settings/base.py - 3 = exome_slicer/)
...
LOCAL_APPS = [
    ...
    "exome_slicer.quality_stats.apps.QualityStatsConfig",
]
...
MIGRATION_MODULES = {"sites": "exome_slicer.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "exome_slicer.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Michael A. Gonzalez""", "GonzalezMA@email.chop.edu")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "exome_slicer.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "exome_slicer.users.adapters.SocialAccountAdapter"
...
GRAPHENE = {
    "SCHEMA": "exome_slicer.graphql.schema.schema",
